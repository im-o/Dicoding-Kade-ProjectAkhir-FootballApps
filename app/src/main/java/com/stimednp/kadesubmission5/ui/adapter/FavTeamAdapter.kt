...
class FavTeamAdapter(private val context: Context?, private val teams: ArrayList<DataFavoriteTeam>) : RecyclerView.Adapter<FavTeamAdapter.TeamsViewHolder>() {
    ...
    class TeamsViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        fun bindItem(data: DataFavoriteTeam) {
