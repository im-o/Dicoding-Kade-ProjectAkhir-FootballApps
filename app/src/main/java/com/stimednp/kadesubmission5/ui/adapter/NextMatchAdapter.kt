...
class NextMatchAdapter(
    private val context: Context?, private val items: ArrayList<DataNextMatch>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NextMatchViewHolder {
        return NextMatchViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_nextmatch, parent, false))
    }
    ...
    class NextMatchViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        fun bindItem(itemsE: DataNextMatch?, badgesH: DataTeamsBadge?, badgesA: DataTeamsBadge?) {
